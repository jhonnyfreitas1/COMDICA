...
@section('content')		
<h5 class="m-2 col-11 rounded col-md-3 bg-success text-light">Aqui você pode obter os dados referentes aos boletos gerados para pagamento, por exemplo o status do boleto e recibo comprovante de doação.</h5>
@if(session('mensagem'))
<p class="alert text-alert bg-warning text-dark col-md-5 col-5 text-center">CPF não encontrado.</p>
@endif
<div class=" row-2 ">
  <form class="mt-4  col-10" action="/status" method="get">

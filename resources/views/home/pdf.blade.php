...
<body>
<img style=" width: 50%; margin-left: 30%;"  src="https://comdicaaracoiabape.com.br/img/fundeca.png">
    <h1 style="margin-top:0.5em;">RECIBO </h1><br>
	<div class="content bg-dark container row-2">
        <h2> Declaro para os devidos fins de comprovação que o Fundo Municipal dos Direitos da Criança e do Adolescente – FUNDECA. Fundo Público instituído pela Lei Municipal nº 0305/2014. Com sede na cidade de Araçoiaba-PE.
         Inscrito no CNPJ/MF sob o nº 26.615.546/0001 – 40. 
         <br><br>Recebeu do(a) Sr(a) {{ucfirst($nome)}}, inscrito no Cadastro Pessoa Física sob o número:{{$cpf}}. A importância de R$ {{$valor}} ({{$valorextenso}})
         referente ao ano calendário de {{date('Y')}} Esta é uma modalidade de doação onde à sociedade decide se deixa para a Receita Federal ou destina para investimento em seu Município. PORTANTO EM NOME DO MUNICÍPIO DE ARAÇOIABA – PE, AGRADECEMOS A SUA ATITUDE!
           <br><br> Os recursos do FUNDECA são utilizados para a implementação da política de promoção, defesa e proteção dos direitos da criança e adolescente em conformidade com as diretrizes formalmente deliberadas pelo Conselho Municipal de Defesa de Direitos da Criança e do Adolescente - COMDICA
         </h2>
		...
		<div style="margin-top:1em;" class="div2">
			...
			Ou entre na pagina da comdicaaracoiabape.com.br  vá em  > Sou doador > na parte verificar código digite:  <b>{{$codigo}}</b><br>Código de barra do boleto para identificação:{{$codigo_barra}}
		</div>
	</div>

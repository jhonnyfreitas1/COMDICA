...
<img style=" width: 50%; margin-left: 30%;"  src="https://comdicaaracoiabape.com.br/img/fundeca.png">
	...
	<div class="content bg-dark container row-2">
		...
		<div style="margin-top:1em;" class="div2">
			...
			Ou entre na pagina da comdicaaracoiabape.com.br  vá em  > Sou doador > na parte verificar código digite:  <b>{{$codigo}}</b><br>Código de identificação do carnê:{{$codigo_barra}}
		</div>
	</div>

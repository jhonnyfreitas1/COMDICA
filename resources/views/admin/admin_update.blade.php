                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('admin.update.save') }}">
                        ...
                        <div class="form-group row">
                            <label for="name" class="text-dark col-md-4 col-form-label text-md-right">{{ __('Novo nome') }}</label>
                        ...
                        <div class="form-group row">
                            <label for="email" class="text-dark col-md-4 col-form-label text-md-right">{{ __('Novo Endereço de e-mail') }}</label>
                        ...
                        <div class="form-group row">
                            <label for="password" class="text-dark col-md-4 col-form-label text-md-right">{{ __('Nova Senha') }}</label>
